### Ablation: definitions without profile field

| Metric | Value | Basis |
|---|---|---|
| **Detection F1** | **0.919** | 17 TP, 2 FP, 1 FN |
| Recall | 0.944 | 17/18 blockers found |
| Precision | 0.895 | 17/19 claims correct |
...
| Missing evidence | 100.0% | of 19 claims |
| Parse failures | 0.0% | of 24 postings |
| Cost per task | $0.0044 | $0.10 total, 30,257 in / 4,432 out |
