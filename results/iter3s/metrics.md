### Iteration 3s (evidence, no decomposition)

| Metric | Value | Basis |
|---|---|---|
| **Detection F1** | **0.895** | 17 TP, 3 FP, 1 FN |
| Recall | 0.944 | 17/18 blockers found |
| Precision | 0.850 | 17/20 claims correct |
...
| Hallucinated quotes | 5.0% | of 20 claims |
| Missing evidence | 0.0% | of 20 claims |
| Parse failures | 0.0% | of 24 postings |
| Cost per task | $0.0042 | $0.10 total, 37,913 in / 2,613 out |
